...
import { Updateposts} from '../../api/Control'
...
export default function Updatepost({id,title,device,description,closeModal}) {
  ...
  return (
    <>
        <h2 className="text-2xl text-gray-800 font-semibold mb-4">Edit Posts</h2>
        ...
        <div className="mb-4">
          ...
          <div className="flex">
            <button type="submit" className="bg-gray-800 text-white px-4 py-2 w-full rounded-lg hover:bg-gray-700 focus:outline-none focus:bg-gray-600">Update Posts</button>
          </div>
        </form>
    </>
  )
