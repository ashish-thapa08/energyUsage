...
export default function Userdash() {
  ...
  return (
    ...
    <div class="px-8 py-5">
    <nav className="flex space-x-6 fixed z-10 bg-white">
...
>
  ...
  <Link to="#" onClick={Profilee}className={`text-gray-800 font-semibold flex items-start transition-all duration-300 hover:bg-gray-800 ${profile ? 'bg-gray-800 text-white' : 'hover:text-white'} px-3 py-2 rounded-lg`}
>
