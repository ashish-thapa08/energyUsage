...
import { Devices } from "../../api/Control";
...
export default function CreateDevice() {
  const formik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting, setErrors, resetForm }) => {
      let returnData = await Devices(values);
      ...
      <div className="bg-white mt-8 mb-10 ml-[25rem] w-[25rem] p-8 rounded-lg shadow-lg">
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <div className="flex">
            <button
              type="submit"
              className="bg-gray-800 text-white px-4 py-2 w-full rounded-lg hover:bg-gray-700 focus:outline-none focus:bg-gray-600"
            >
              Add Device
            </button>
          </div>
